...
final case class BikeMessage(
                            ...
                            ) extends scalapb.GeneratedMessage with scalapb.Message[BikeMessage] with scalapb.lenses.Updatable[BikeMessage] {
  @transient
  ...
  private[this] def __computeSerializedValue(): _root_.scala.Int = {
    ...
    if (approval != bikes.infrastructure.protobuf.ApprovalEnumType.PENDING) {
      __size += _root_.com.google.protobuf.CodedOutputStream.computeEnumSize(6, approval.value)
    }
    __size
  }
  ...
  def mergeFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): bikes.infrastructure.protobuf.BikeMessage = {
  ...
  def withManufacturer(__v: _root_.scala.Predef.String): BikeMessage = copy(manufacturer = __v)

  def withName(__v: _root_.scala.Predef.String): BikeMessage = copy(name = __v)

  def withWeight(__v: _root_.scala.Float): BikeMessage = copy(weight = __v)

  def withValue(__v: _root_.scala.Float): BikeMessage = copy(value = __v)

  def clearParts = copy(parts = _root_.scala.collection.Seq.empty)

  def addParts(__vs: bikes.infrastructure.protobuf.PartType*): BikeMessage = addAllParts(__vs)

  def addAllParts(__vs: TraversableOnce[bikes.infrastructure.protobuf.PartType]): BikeMessage = copy(parts = parts ++ __vs)

  def withParts(__v: _root_.scala.collection.Seq[bikes.infrastructure.protobuf.PartType]): BikeMessage = copy(parts = __v)

  def withApproval(__v: bikes.infrastructure.protobuf.ApprovalEnumType): BikeMessage = copy(approval = __v)
  ...
  def getField(__field: _root_.scalapb.descriptors.FieldDescriptor): _root_.scalapb.descriptors.PValue = {
    ...
    (__field.number: @_root_.scala.unchecked) match {
      ...
      case 6 => _root_.scalapb.descriptors.PEnum(approval.scalaValueDescriptor)
    }
  }

  def toProtoString: _root_.scala.Predef.String = _root_.scalapb.TextFormat.printToUnicodeString(this)

  def companion = bikes.infrastructure.protobuf.BikeMessage
}

object BikeMessage extends scalapb.GeneratedMessageCompanion[bikes.infrastructure.protobuf.BikeMessage] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[bikes.infrastructure.protobuf.BikeMessage] = this

  def fromFieldsMap(__fieldsMap: scala.collection.immutable.Map[_root_.com.google.protobuf.Descriptors.FieldDescriptor, scala.Any]): bikes.infrastructure.protobuf.BikeMessage = {
    ...
    bikes.infrastructure.protobuf.BikeMessage(
      ...
      bikes.infrastructure.protobuf.ApprovalEnumType.fromValue(__fieldsMap.getOrElse(__fields.get(5), bikes.infrastructure.protobuf.ApprovalEnumType.PENDING.javaValueDescriptor).asInstanceOf[_root_.com.google.protobuf.Descriptors.EnumValueDescriptor].getNumber)
    )
  }

  implicit def messageReads: _root_.scalapb.descriptors.Reads[bikes.infrastructure.protobuf.BikeMessage] = _root_.scalapb.descriptors.Reads {
    case _root_.scalapb.descriptors.PMessage(__fieldsMap) =>
      ...
      bikes.infrastructure.protobuf.BikeMessage(
        ...
        bikes.infrastructure.protobuf.ApprovalEnumType.fromValue(__fieldsMap.get(scalaDescriptor.findFieldByNumber(6).get).map(_.as[_root_.scalapb.descriptors.EnumValueDescriptor]).getOrElse(bikes.infrastructure.protobuf.ApprovalEnumType.PENDING.scalaValueDescriptor).number)
      )
    case _ => throw new RuntimeException("Expected PMessage")
  }

  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = BikesProto.javaDescriptor.getMessageTypes.get(1)

  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = BikesProto.scalaDescriptor.messages(1)
  ...
  def enumCompanionForFieldNumber(__fieldNumber: _root_.scala.Int): _root_.scalapb.GeneratedEnumCompanion[_] = {
    (__fieldNumber: @_root_.scala.unchecked) match {
      case 6 => bikes.infrastructure.protobuf.ApprovalEnumType
    }
  }

  lazy val defaultInstance = bikes.infrastructure.protobuf.BikeMessage(
  )

  implicit class BikeMessageLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, bikes.infrastructure.protobuf.BikeMessage]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, bikes.infrastructure.protobuf.BikeMessage](_l) {
  ...
  final val APPROVAL_FIELD_NUMBER = 6
}
